...
class FormFieldOfDoctorInOperator extends StatefulWidget {
  const FormFieldOfDoctorInOperator({Key? key}) : super(key: key);

  @override
  _FormFieldOfDoctorInOperatorState createState() =>
      _FormFieldOfDoctorInOperatorState();
}

class _FormFieldOfDoctorInOperatorState
    extends State<FormFieldOfDoctorInOperator> {
  ...
  void _saveForm() {
   ...
   if (!isValide!) {
      ...
      Navigator.of(context).pushReplacementNamed(DoctorListScreenViewOperator.namedRoute);
    }
