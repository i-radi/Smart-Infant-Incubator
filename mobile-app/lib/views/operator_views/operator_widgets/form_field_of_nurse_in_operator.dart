...
class FormFieldOfNurseInOperato extends StatefulWidget {
  const FormFieldOfNurseInOperato({Key? key}) : super(key: key);

  @override
  _FormFieldOfNurseInOperatoState createState() =>
      _FormFieldOfNurseInOperatoState();
}

class _FormFieldOfNurseInOperatoState extends State<FormFieldOfNurseInOperato> {
  ...
  void _saveForm() {
    ...
    if (!isValide!) {
      ...
      Navigator.of(context).pushReplacementNamed(NurseListScreenViewOperator.namedRoute);
    }
