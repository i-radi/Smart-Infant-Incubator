...
class ImageBoxOfBabyInOperator extends StatefulWidget {
  const ImageBoxOfBabyInOperator({Key? key}) : super(key: key);

  @override
  _ImageBoxOfBabyInOperatorState createState() =>
      _ImageBoxOfBabyInOperatorState();
}

class _ImageBoxOfBabyInOperatorState extends State<ImageBoxOfBabyInOperator> {
  File? _storedImage;
