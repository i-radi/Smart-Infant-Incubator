...
class DetailsOfDialogForAddIncubatorInOperator extends StatefulWidget {
  const DetailsOfDialogForAddIncubatorInOperator({Key? key}) : super(key: key);

  @override
  _DetailsOfDialogForAddIncubatorInOperatorState createState() =>
      _DetailsOfDialogForAddIncubatorInOperatorState();
}

class _DetailsOfDialogForAddIncubatorInOperatorState
    extends State<DetailsOfDialogForAddIncubatorInOperator> {
