...
class ImageBoxOfDoctorInOperator extends StatefulWidget {
  const ImageBoxOfDoctorInOperator({Key? key}) : super(key: key);

  @override
  _ImageBoxOfDoctorInOperatorState createState() =>
      _ImageBoxOfDoctorInOperatorState();
}

class _ImageBoxOfDoctorInOperatorState
    extends State<ImageBoxOfDoctorInOperator> {
  File? _storedImage;
