...
class FormFieldOfNurseInAdmin extends StatefulWidget {
  const FormFieldOfNurseInAdmin({Key? key}) : super(key: key);

  @override
  _FormFieldOfNurseInAdminState createState() =>
      _FormFieldOfNurseInAdminState();
}

class _FormFieldOfNurseInAdminState extends State<FormFieldOfNurseInAdmin> {
  ...
  void _saveForm() {
    ...
    if (!isValide!) {
      ...
      Navigator.of(context).pushReplacementNamed(NurseListScreenViewAdmin.namedRoute);
    }
